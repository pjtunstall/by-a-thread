...
This section assumes you're on Linux. I haven't tried running the game locally on Windows or Mac. On Windows, at least, local networking fail due to the technique I found to let the client discover its own binding address by pinging a known external address.
