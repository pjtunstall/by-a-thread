...
pub struct Assets {
    ...
    pub brown_rust_texture: Texture2D,
...
impl Assets {
    pub async fn load() -> Self {
        ...
        let brown_rust_bytes = include_bytes!("../assets/images/rust-brown.png");
        let brown_rust_texture = Texture2D::from_file_with_format(brown_rust_bytes, None);
