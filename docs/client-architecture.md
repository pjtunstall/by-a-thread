...
- **Shared services**: Consider a small `ClientContext` passed to phases containing `NetworkHandle`, `Assets`, `Time`, and `Ui` references. This simplifies signatures and makes future testing/mocking easier.
